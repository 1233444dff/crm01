...
//    多条分页查询营销机会
    ...
    public void save(SaleChance saleChance){
        //参数校验
        checkParams(saleChance.getChanceSource(),saleChance.getLinkMan(),saleChance.getLinkPhone());
        //2.设置相关参数默认值
        //未选择分配人
    ...
    private void checkParams(String customerName, String linkMan, String linkPhone) {
        ...
        AssertUtil.isTrue(StringUtils.isBlank(linkPhone),"手机号格式不正确！");
...
//       删除数据
        AssertUtil.isTrue(saleChanceMapper.deleteBatch(ids)<0,"营销机会数据删除失效");
    }
